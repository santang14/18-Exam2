...
Authors: David Mutchler, Dave Fisher, Matt Boutell, their colleagues,
         and Gerardo Santana.  October 2018.
 ...
 s
    ...
    def rain(self, rain_amount):
        ...
        if rain_amount > self.water:
            rain = self.water
            self.water = 0
            self.total_water_loss = self.total_water_loss + rain
            return rain
        self.water = self.water - rain_amount
        self.total_water_loss = self.total_water_loss + rain_amount
        return rain_amount
